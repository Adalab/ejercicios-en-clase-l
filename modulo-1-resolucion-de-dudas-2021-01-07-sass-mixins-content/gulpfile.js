...
gulp.task(
  ...
  gulp.series(['clean', 'api', 'html', 'css', 'js', 'images'], done => {
    ...
    gulp.watch(config.api.src, { usePolling: true }, gulp.series(['api', 'bs-reload']));
    gulp.watch(config.css.src, { usePolling: true }, gulp.series('css'));
    gulp.watch(config.images.src, { usePolling: true }, gulp.series(['images', 'bs-reload']));
    gulp.watch(config.js.src, { usePolling: true }, gulp.series(['js', 'bs-reload']));
    gulp.watch(config.watch.html, { usePolling: true }, gulp.series(['html', 'bs-reload']));
    done();
  })
);
